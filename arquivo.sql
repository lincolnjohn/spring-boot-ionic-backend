...
INSERT INTO `cidade` VALUES (1,'Belém',1),(2,'Santarém',1),(3,'Rio de Janeiro',2),(4,'Parati',2);
...
INSERT INTO `cliente` VALUES (1,'1223334343','hulk@email.com','Incrivel Hulk',1);
...
INSERT INTO `endereco` VALUES (1,'Vingadores','665544','perto do beco','Rua verde forte','344',2,1),(2,'Radiação Gama','55666','próximo posto','Avenida Verde gama','444',1,1);
...
INSERT INTO `estado` VALUES (1,'Para'),(2,'Rio de Janeiro');
...
INSERT INTO `pedido` VALUES (1,'2017-05-20 00:00:00',1,1),(2,'2017-10-20 00:00:00',1,2);
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',20),(4,'Mesa de escritório',300),(5,'Toalha',50),(6,'Colcha',200),(7,'TV true color',1200),(8,'Roçadeira',800),(9,'Abajour',100),(10,'Pendente',180),(11,'Shampoo',90);
...
INSERT INTO `telefone` VALUES (1,'5544666'),(1,'234454555');
...
-- Dump completed on 2018-07-12 14:04:23
